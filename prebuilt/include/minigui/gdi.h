...
/*
 * $Id: gdi.h 13822 2012-01-15 10:56:34Z weiym $
 *
...
#define FONT_TYPE_BITMAP_SXF        0x0006  /* "sxf" */
...
MG_EXPORT int Utf8_to_Gb(unsigned char *dest, const char *str_utf8);
MG_EXPORT int ucs8_to_16(unsigned short *dest, const char *str);
MG_EXPORT int Utf8_to_Jis(unsigned char *dest, const char *str_utf8);
MG_EXPORT int Utf8_to_Euckr(unsigned char *dest, const char *str_utf8);
