...
public:
    CameraParameters();
    CameraParameters(const std::string &params) { unflatten(params); }
    ~CameraParameters();

    std::string flatten() const;
    void unflatten(const std::string &params);
    ...
    void getSupportedPreviewSizes(std::vector<Size> &sizes) const;
    ...
    void getSupportedVideoSizes(std::vector<Size> &sizes) const;
    ...
    void getSupportedVideoSizesWithFPS(std::vector<SizeFPS> &sizes) const;
    ...
    void getSupportedPictureSizes(std::vector<Size> &sizes) const;
    void setPictureFormat(const char *format);
    const char *getPictureFormat() const;
    void getSupportedPreviewFrameRates(std::vector<int> &frameRates) const;
    ...
    void setVideoBufferFrameNum(int number);
    int getVideoBufferFrameNum();
    ...
    void dump() const;
    int dump(int fd, const std::vector<std::string>& args) const;
	...
	static const char KEY_CAPTURE_FORMAT[];
	static const char KEY_CAPTURE_OUT_FORMAT[];
    static const char KEY_COLOR_SPACE[];    //value: v4l2_colorspace, V4L2_COLORSPACE_JPEG
    ...
    static const char KEY_AWEXTEND_VIDEO_BUFFER_FRAME_NUM[];

    static const char KEY_AWEXTEND_PREVIEW_ROTATION[];

    static const char KEY_AWEXTEND_SUPPORTED_VIDEO_SIZES_WITH_FPS[];
